...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 end-6 z-50 flex items-center justify-center w-14 h-14 bg-[#25D366] hover:bg-[#20bd5a] rounded-full shadow-lg transition-all duration-300 hover:scale-110 group"
    >
